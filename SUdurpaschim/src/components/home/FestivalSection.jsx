    ...
    <section className="mx-auto grid max-w-[1400px] gap-8 px-5 py-20 sm:px-8 lg:grid-cols-[0.95fr_1.05fr] lg:px-[min(7vw,84px)]">
      <div className="self-center">
        ...
        <h2 className="font-[Cormorant_Garamond] text-[clamp(3rem,5vw,4.5rem)] leading-[0.95] tracking-[-0.03em] text-[#173128]">
          The Soul of
          <br />
          <em className="font-semibold italic text-[#e5a45e]">Gaura Parva</em>
        </h2>
        <p className="mt-5 max-w-xl text-base text-[#4e564b]">
          Across the far west, Gaura binds ritual, devotion, music, and
          community. It is one of the strongest anchors of Sudurpashchim&apos;s
          identity and a powerful cultural story for this site.
        </p>
        <Link
          to="/culture"
      ...
      <div className="relative min-h-[340px] overflow-hidden rounded-[2rem] shadow-[0_24px_70px_rgba(14,31,26,0.14)] sm:min-h-[500px]">
        <img src={siteVisuals.gaura} alt="Gaura visual" className="h-full w-full object-cover" />
